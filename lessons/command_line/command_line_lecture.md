...
> Question: How could we make sure that we moved? Run 'pwd' to see where we are. 
...
would we do that? echo curl (website data) > data.txt
...
> What changed? How the file size is represented. 
